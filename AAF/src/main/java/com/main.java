...
@RequestMapping("/AAF/{request_id}")
public String AAF (@PathVariable(value = "request_id") String requestid) {
    ...
    public String Save (@PathVariable(value = "request_id") String request_id, @PathVariable(value = "user_ip") String user_ip) {
        ...
        System.out.println("Save (): Save a new request in the database");
        System.out.println("Save(): request_id="+request_id);
        System.out.println("Save (): user_ip="+user_ip);
        System.out.println("Save (): date_value="+date_value);
        return "DONE";
    }
